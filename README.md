...
```
cd existing_repo
git remote add origin https://gitlab.com/KamouloxBigboi/projet-demo-devops-v1.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/KamouloxBigboi/projet-demo-devops-v1/-/settings/integrations)
...
## Key Features
- **MERN Stack**: MongoDB, Express/Node.js REST API, React frontend
